...
export default function AtlasDashboard({
  ...
  const currentWindowAdjective = snapshot.currentWindowHours % 24 === 0
    ? `${snapshot.currentWindowHours / 24}-day`
    : `${snapshot.currentWindowHours}-hour`;
  ...
  return (
    <div className={`${styles.page} ${production ? styles.production : ""} ${compact ? styles.compact : ""}`}>
      ...
      {!compact ? <section className={styles.metricStrip} aria-label="Market snapshot">
        ...
        <article><span>Current-cycle sample</span><strong>{formatCount(snapshot.recentListings)}</strong><small>live rows seen within the {currentWindowAdjective} window</small></article>
        ...
        <section className={`${styles.panel} ${styles.comparePanel}`} aria-labelledby="compare-title">
          ...
          <div className={styles.compareWorkspace}>
            ...
            <div className={styles.comparisonChart} aria-live="polite">
              ...
              <p className={styles.chartNote}>Single-animal, fixed-price public listings · confirmed within {currentWindow} · asks are not completed sales</p>
            </div>
          </div>
        </section>
        ...
        <aside className={`${styles.panel} ${styles.scopePanel}`} aria-labelledby="scope-title">
          ...
          <div className={styles.scopeLayers}>
            <article>
              ...
              <p>Live catalogue rows re-confirmed in the current {currentWindowAdjective} ingest window. Used for the trait comparisons on this page.</p>
